...
function GameBoard() {
	...
	return (
		<div className="grid grid-cols-4 grid-rows-3 gap-4 py-4 px-8 border-1 border-black h-screen w-full bg-background-color gap-2">
			...
			<div className="sm:col-start-1 sm:row-start-1 sm:col-span-1 sm:row-span-1 sm:h-full sm:w-full flex sm:justify-end sm:items-end justify-start items-center">
				<div
					onClick={(event) => handleClick(event)}
					className="sm:h-3/4 sm:w-1/2 w-full h-1/2 mx-0"
					data-content="rda"
			...
			<div className="sm:col-start-1 sm:row-start-3 sm:col-span-1 sm:row-span-1 sm:h-full sm:w-full flex sm:justify-end sm:items-start col-start-2 row-start-1 justify-end items-center">
				<div
					onClick={(event) => handleClick(event)}
					className="sm:h-3/4 sm:w-1/2 w-full h-1/2 mx-0"
					data-content="pnp"
			...
			<div className="sm:col-start-4 sm:row-start-3 sm:col-span-1 sm:row-span-1 sm:h-full sm:w-full flex sm:justify-start sm:items-start col-start-3 row-start-1 justify-end items-center">
				<div
					className="sm:h-3/4 sm:w-1/2 w-full h-1/2 mx-0"
					onClick={(event) => handleClick(event)}
			...
			<div
				onClick={(event) => handleClick(event)}
				data-content="cv"
				className="sm:col-start-2 sm:row-start-1 sm:col-span-2 sm:row-span-3 sm:h-5/6 sm:w-5/6 sm:mx-auto sm:my-auto h-full w-full row-start-2 row-span-2 col-span-4 flip-card"
				// onClick={(event) => handleClick(event)}
